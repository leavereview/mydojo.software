...
If you run a [BJJ gym](/bjj-gym-software/), deciding when to promote students requires balancing multiple factors:
...
Track student progress systematically. [Martial arts software](/dojo-management-software/) can help record:
