...
Whether you're considering [opening a martial arts school](/blog/cost-to-open-gym/) or trying to increase your current income, understanding the economics helps you make informed decisions.
...
- Website and [management software](/dojo-management-software/)
...
<div style="background: linear-gradient(135deg, #FFE7EC 0%, #FFF5F7 100%); border-left: 4px solid #E94560; padding: 1.5rem; border-radius: 0.5rem; margin: 2rem 0;">
  <div style="display: flex; align-items: start; gap: 1rem;">
    ...
    <div style="flex: 1;">
      <h3 style="font-size: 1.25rem; font-weight: 700; color: #1A1A2E; margin: 0 0 0.5rem 0;">Calculate Your Actual Profit Margin</h3>
      <p style="color: #4A4A5E; margin: 0 0 1rem 0; line-height: 1.6;">Want to know your real take-home? Use our free calculator to model your revenue streams, operating costs, and see exactly where you stand compared to industry benchmarks for profit margins.</p>
