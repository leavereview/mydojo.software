...
This guide breaks down the actual costs of opening a gym, from initial investment through ongoing operations. Whether you're planning a [martial arts school](/dojo-management-software/), [MMA gym](/mma-gym-software/), or general fitness facility, these numbers will help you build a realistic budget.
...
|--------|------------|-------|
| Management software | $0-$200/month | [Dojo software](/dojo-management-software/), gym management |
...
<div style="background: linear-gradient(135deg, #FFE7EC 0%, #FFF5F7 100%); border-left: 4px solid #E94560; padding: 1.5rem; border-radius: 0.5rem; margin: 2rem 0;">
  <div style="display: flex; align-items-start; gap: 1rem;">
    ...
    <div style="flex: 1;">
      <h3 style="font-size: 1.25rem; font-weight: 700; color: #1A1A2E; margin: 0 0 0.5rem 0;">Plan Your Operating Costs & Revenue</h3>
      <p style="color: #4A4A5E; margin: 0 0 1rem 0; line-height: 1.6;">Now that you know your startup costs, use our free calculator to model your monthly revenue, operating expenses, and break-even point. See exactly how many students you need and what your profit margins could look like.</p>
...
**Small martial arts school:** $50,000-$150,000
**Mid-size facility:** $100,000-$300,000
**Full-service gym:** $200,000-$1,000,000+
